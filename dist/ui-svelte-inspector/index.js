...
const maybeGet$1 = (thing) => (isFunction(thing) ? thing() : thing);
...

  {
    var consequent = ($$anchor) => {
      ...
      $.template_effect(() => {
        ...
        $.set_attribute(img, 'data-position', position.current ?? 1);
      });

      $.delegated('click', img, handleOpen);
      $.delegated('keydown', img, handleKeyDown);
      $.append($$anchor, img);
    };

    $.if(node, ($$render) => {
      if (!open.current) $$render(consequent);
    });
  }
...
function Details($$anchor, $$props) {
  ...
  const handleToggle = (event) => {
    open.current = event.currentTarget.open;
  };

  const handleKeyDown = (event) => {
    if (event.key == 'Enter' || event.key == ' ') {
      event.preventDefault();
      $$props.handleEditable?.(event);
    }
  };
...

  {
    var consequent = ($$anchor) => {
      ...
      $.template_effect(() => {
        ...
        $.set_attribute(img, 'title', editable() ? 'Done editing' : 'Edit');
      });

      $.delegated('click', img, function (...$$args) {
...
const maybeGet = (value) => (isFunction(value) ? value() : value);
const getEditable = (uniqueId, s) => {
    ...
    var consequent_1 = ($$anchor) => {
      {
        ...
        Details($$anchor, {
          ...
          children: ($$anchor, $$slotProps) => {
            ...
            {
              var consequent = ($$anchor) => {
                var text = $.text('No indexes defined');
    ...
    var consequent_1 = ($$anchor) => {
      {
        ...
        Details($$anchor, {
          ...
          children: ($$anchor, $$slotProps) => {
            ...
            {
              var consequent = ($$anchor) => {
                var text = $.text('No metrics defined');
...
function QueryView($$anchor, $$props) {
  ...
  const handleChange = (sortAndOffset) => {
  ...
  Details($$anchor, {
    ...
    children: ($$anchor, $$slotProps) => {
      ResultSortedTableInHtmlTable($$anchor, {
        get queryId() {
    ...
    var consequent_1 = ($$anchor) => {
      {
        ...
        Details($$anchor, {
          ...
          children: ($$anchor, $$slotProps) => {
            ...
            {
              var consequent = ($$anchor) => {
                var text = $.text('No queries defined');
...
function RelationshipView($$anchor, $$props) {
  ...
  Details($$anchor, {
    ...
    children: ($$anchor, $$slotProps) => {
      RelationshipInHtmlTable($$anchor, {
        get relationshipId() {
          return $$props.relationshipId;
        },
    ...
    var consequent_1 = ($$anchor) => {
      {
        ...
        Details($$anchor, {
          ...
          children: ($$anchor, $$slotProps) => {
            ...
            {
              var consequent = ($$anchor) => {
                var text = $.text('No relationships defined');
...
function Delete($$anchor, $$props) {
  ...
  $.delegated('click', img, handleClick);
  $.append($$anchor, fragment);
  $.pop();
}
...
function NewId($$anchor, $$props) {
  ...
  let previousSuggestedId = $.state(undefined);
  ...
  const handleNewIdChange = (event) => {
    $.set(newId, event.currentTarget.value, true);
  ...
  var img = $.sibling(input_1, 2);

  $.template_effect(() => {
    $.set_text(text, `${prompt() + ': '} `);
    ...
    $.set_class(img, 1, $.clsx($.get(newIdOk) ? 'ok' : 'okDis'));
  });
...
function ConfirmableActions($$anchor, $$props) {
  ...
  let confirming = $.state(undefined);

  const handleDone = () => {
    $.set(confirming, undefined);
  };

  const handleKeyDown = (event) => {
    if (!isUndefined($.get(confirming)) && event.key == 'Escape') {
      event.preventDefault();
      handleDone();
    }
  };
...

  {
    var consequent_1 = ($$anchor) => {
      ...
      $.delegated('click', img, handleDone);
      $.append($$anchor, fragment_1);
    };
    ...
    var alternate_1 = ($$anchor) => {
      ...
      $.each(
        ...
        ($$anchor, action, index) => {
          ...
          $.delegated('click', img_1, () => $.set(confirming, index, true));
          $.append($$anchor, img_1);
        },
      );
...
function TablesActions($$anchor, $$props) {
  ...
  const getStore = resolveStore(() => $$props.store);
  const tableIds = getTableIds(() => $$props.store);
  const has = (tableId) => getStore()?.hasTable(tableId) ?? false;
  ...
  const addActions = $.derived(() => [
    {
      ...
      has,
      set: (newId) => getStore()?.setTable(newId, {row: {cell: ''}}),
    },
  ]);
...
function RowActions($$anchor, $$props) {
  ...
  const hasCell = (cellId) =>
    getStore()?.hasCell($$props.tableId, $$props.rowId, cellId) ?? false;
  const hasRow = (nextRowId) =>
    getStore()?.hasRow($$props.tableId, nextRowId) ?? false;
  ...
  const actions = $.derived(() => [
    {
      ...
      has: hasCell,
      set: (newId) =>
        getStore()?.setCell($$props.tableId, $$props.rowId, newId, ''),
    },

    {
      ...
      title: 'Clone row',
      prompt: 'Clone row to',
      suggestedId: getNewIdFromSuggestedId($$props.rowId, (nextRowId) =>
      ...
      set: (newId) =>
        getStore()?.setRow(
          $$props.tableId,
          newId,
          getStore()?.getRow($$props.tableId, $$props.rowId),
        ),
    },

    {
      ...
      title: 'Delete row',
      prompt: 'Delete row',
      onClick: () => getStore()?.delRow($$props.tableId, $$props.rowId),
    },
  ]);
...
function TableActions1($$anchor, $$props) {
  ...
  const has = (rowId) => getStore()?.hasRow($$props.tableId, rowId) ?? false;
  ...
  const actions = $.derived(() => [
    {
      ...
      set: (newId) =>
        getStore()?.setRow(
          ...
          objNew(
            arrayMap(
              getStore()?.getTableCellIds($$props.tableId) ?? [],
              (cellId) => [cellId, ''],
            ),
          ),
        ),
...
function TableActions2($$anchor, $$props) {
  ...
  const getStore = resolveStore(() => $$props.store);
  const tableIds = getTableIds(() => $$props.store);
  const has = (nextTableId) => getStore()?.hasTable(nextTableId) ?? false;
  ...
  const actions = $.derived(() => [
    {
      ...
      suggestedId: getNewIdFromSuggestedId($$props.tableId, (nextTableId) =>
        arrayHas(tableIds.current, nextTableId),
      ),
      has,
      set: (newId) =>
        getStore()?.setTable(newId, getStore()?.getTable($$props.tableId)),
    },

    {
      ...
      title: 'Delete table',
      prompt: 'Delete table',
      onClick: () => getStore()?.delTable($$props.tableId),
    },
  ]);
...
function ValueActions($$anchor, $$props) {
  ...
  const getStore = resolveStore(() => $$props.store);
  const valueIds = getValueIds(() => $$props.store);
  const has = (nextValueId) => getStore()?.hasValue(nextValueId) ?? false;
  ...
  const actions = $.derived(() => [
    {
      ...
      suggestedId: getNewIdFromSuggestedId($$props.valueId, (nextValueId) =>
      ...
      set: (newId) =>
        getStore()?.setValue(
          newId,
          getStore()?.getValue($$props.valueId) ?? '',
        ),
    },

    {
      ...
      title: 'Delete value',
      prompt: 'Delete value',
      onClick: () => getStore()?.delValue($$props.valueId),
    },
  ]);
...
function ValuesActions($$anchor, $$props) {
  ...
  const getStore = resolveStore(() => $$props.store);
  const valueIds = getValueIds(() => $$props.store);
  const has = (valueId) => getStore()?.hasValue(valueId) ?? false;
  ...
  const addActions = $.derived(() => [
    {
      ...
      has,
      set: (newId) => getStore()?.setValue(newId, ''),
    },
  ]);
...
function StoreView($$anchor, $$props) {
  ...
  const title = $.derived(
    () =>
      ($.get(store)?.isMergeable() ? 'Mergeable' : '') +
      'Store: ' +
...
function Body($$anchor, $$props) {
...

  {
    var consequent = ($$anchor) => {
      ...
      $.reset(span);
      $.template_effect(() => $.set_text(text, NO_PROVIDED_OBJECTS_MESSAGE));
      $.append($$anchor, span);
    };
    ...
    var alternate = ($$anchor) => {
      ...
      $.each(
        ...
        ($$anchor, relationshipsId) => {
          RelationshipsView($$anchor, {
            get relationshipsId() {
...
function ErrorBoundary($$anchor, $$props) {
...

  {
    const failed = ($$anchor, /* istanbul ignore next */ _error = $.noop, /* istanbul ignore next */ _reset = $.noop) => {
      ...
      $.reset(span);
      $.template_effect(() => $.set_text(text, INSPECTOR_ERROR_MESSAGE));
      $.append($$anchor, span);
    };

    $.boundary(node, {onerror: handleError, failed}, ($$anchor) => {
      var fragment_1 = $.comment();
      var node_1 = $.first_child(fragment_1);
...
function Header($$anchor, $$props) {
    ...
    ($$anchor, name, p) => {
...

      {
        var consequent = ($$anchor) => {
          ...
          $.delegated('keydown', img_1, (event) =>
            onKeyDown(event, () => $$props.s.setValue(POSITION_VALUE, p)),
          );
          $.append($$anchor, img_1);
        };
  ...
  $.delegated('click', img, handleClick);
  $.delegated('keydown', img, (event) => onKeyDown(event, handleClick));
  $.delegated('click', img_2, handleClose);
  $.delegated('keydown', img_2, (event) => onKeyDown(event, handleClose));
  ...
  onMount(() => {
    ...
    void (async () => {
      ...
      await persister.load([
        {},
        {position: getInitialPosition(position()), open: !!open()},
      ]);
